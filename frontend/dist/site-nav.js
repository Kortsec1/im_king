(()=>{
  function mount(){
    ...
    header.innerHTML='<a class="unified-brand" href="/" aria-label="LOOKALIKE LAB 홈">LOOKALIKE <span>LAB</span></a><nav aria-label="주요 메뉴"><a href="/">닮은꼴 찾기</a><a href="/gallery">데이터셋</a><a href="/exhibit">자동 전시</a></nav>';
    header.querySelector('a[href="/exhibit"]').textContent='인물 슬라이드쇼';
    const path=location.pathname.replace(/\.html$/,'').replace(/\/$/,'')||'/';
    header.querySelectorAll('nav a').forEach(a=>{if(a.pathname===path||path==='/detail'&&a.pathname==='/gallery')a.setAttribute('aria-current','page');});
